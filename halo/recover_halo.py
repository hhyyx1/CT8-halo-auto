...
pm2_path = "/home/accbcsj/.npm-global/bin/pm2"
default_restore_command = f"cd domains/ha.7374520.xyz/public_html && chmod +x run.sh && {pm2_path} start ./run.sh --name halo"
